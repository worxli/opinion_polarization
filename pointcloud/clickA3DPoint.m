function h = clickA3DPoint(pointCloud,arg)
%CLICKA3DPOINT
...
h = gcf;
if(arg==1)
    plot3(pointCloud(1,:), pointCloud(2,:), pointCloud(3,:), 'b.', 'MarkerSize', 13);
elseif(arg==2)
    plot3(pointCloud(1,:), pointCloud(2,:), pointCloud(3,:), 'r.', 'MarkerSize', 20);
else
